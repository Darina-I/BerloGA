...
2. Открыть два терминала: в папке packages/client и в packages/server
3. Выполнить команду `npm run dev`

Для того, чтобы открыть документацию API необходимо перейти по ссылке после запуска проекта: http://localhost:3000/docs
